...
public class SessionVisualizerMessagerAPI
{
   ...
   private static final CategoryTheme LeftSidebar = apiFactory.createCategoryTheme("LeftSidebar");
   private static final CategoryTheme RightSidebar = apiFactory.createCategoryTheme("RightSidebar");
   ...
   public static final Topic<Boolean> ShowLeftSidebar = APIRoot.child(LeftSidebar).topic(Show);
   public static final Topic<Boolean> ShowRightSidebar = APIRoot.child(RightSidebar).topic(Show);
